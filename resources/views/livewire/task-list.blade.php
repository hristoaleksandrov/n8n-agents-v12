                    ...
                    @foreach ($tasks as $task)
                        <tr class="hover:bg-gray-50" wire:key="task-{{ $task->id }}">
                            ...
                            <td class="px-4 py-3 text-sm text-gray-600 max-w-xs truncate">
                                {{ Str::limit($task->reference_script, 40) }}
                            </td>
                            <td class="px-4 py-3 text-sm text-gray-600 max-w-xs truncate">
                                {{ Str::limit($task->outcome_description, 30) }}
                            </td>
                            <td class="px-4 py-3">
                                @php
                                    $colors = [
