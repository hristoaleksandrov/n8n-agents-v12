<x-layouts.app title="Task #{{ $task->id }}">
    ...
    <div class="space-y-6">
        ...
        @if ($task->status->value === 'pending' || $task->status->value === 'processing')
            <div id="processing-indicator" class="bg-blue-50 rounded-lg border border-blue-200 p-4 text-center">
                <div class="flex items-center justify-center gap-2">
                    <svg class="animate-spin h-4 w-4 text-blue-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                    <p class="text-blue-700 text-sm">Processing... Auto-refreshing every 3 seconds</p>
                </div>
            </div>
            <script>
